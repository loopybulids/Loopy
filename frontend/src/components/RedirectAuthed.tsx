 ...
 *  so they never see the seller-acquisition page.
 *
 *  Google Identity Services returns the ID token to a callback in the same page,
 *  so unlike the old redirect-based OAuth there's no pending sign-in to resume. */
