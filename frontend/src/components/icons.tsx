...
// Loopy brand mark — a pinwheel of four rounded modular tiles: two larger tiles on
// the ↘ diagonal, two smaller on the ↗ diagonal. Fills with currentColor.
export const Loop = ({ className, size = 20 }: P) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
    <rect x="2" y="2" width="9.2" height="9.2" rx="3" />
    <rect x="13.6" y="2.6" width="7.8" height="7.8" rx="2.6" />
    <rect x="2.6" y="13.6" width="7.8" height="7.8" rx="2.6" />
    <rect x="12.8" y="12.8" width="9.2" height="9.2" rx="3" />
  </svg>
);
