          ...
          <div className="mt-7 grid gap-4 lg:grid-cols-[1fr_360px]">
            ...
            <div className="s-card s-card-glow relative overflow-hidden p-6">
              ...
              <div className="relative">
                ...
                <div className="mt-1 font-display text-[40px] font-extrabold tabular-nums tracking-tight text-white">{rupees(w.available + w.held)}</div>
                <div className="mt-4 grid grid-cols-2 gap-3">
                  ...
                  <div className="rounded-xl border border-white/10 bg-white/[0.03] p-3"><div className="text-[11px] text-[#8A98AD]">Pending Escrow</div><div className="font-display text-[18px] font-extrabold text-white">{rupees(w.held)}</div></div>
                </div>
